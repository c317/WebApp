		...
		<div class="row"> 
			<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3"> 
				...
				<tr>
					...
					<font face="宋体"  color="#FFFFFF"><b>&nbsp;热点新闻</b></font></th>
				</tr>
				<%
				...
				<tr>	
							...
							<td>* <a href="news?newsId=<%=listYzrd.get(i).getId()%>&moduleId=100" title="<%=title%>" target="_blank"><%if(title.length()>8)
			...
			<div class="col-md-9 col-xs-9 col-sm-9 col-lg-9">
				...
				<tr>
					<td style="border-radius:10px 0px 0px 0px;background-color:#4fb2d1"  colspan="2">
						...
						<font face="宋体" color="#FFFFFF"><b>&nbsp;工作动态</b></font></div></td>
				...
				<tr>
					...
					<td><div align="left">
							&nbsp;> <a href="news?newsId=<%=listGzdt.get(i).getId()%>&moduleId=1" target="_blank" title="<%=title%>"><%if(title.length()>25)
				...
				<tr>
					...
					<jsp:include page="pageroll.jsp" flush="true">
						<jsp:param value="getData?moduleId=1" name="action" />
					</jsp:include></td>
				</tr>
			</table>
			</div>			  
