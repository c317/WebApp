		...
		<div id="content">
			<div class="row">
				<div class="col-md-2 col-xs-2 col-sm-2 col-lg-2">
					<%
						request.setAttribute("manageLeftNav", "Kcgl");
					%>
				...
				<div class="col-md-10 col-xs-10 col-sm-10 col-lg-10">
					...
					<ol class="breadcrumb">
						<li><a href="#">业务中心</a></li>
						<li><a href="#" class="active">油气管理</a></li>
					</ol>
					<!-- </td>
					...
					<form action="#" method="post" id="form1" name="form1">
						<%
							request.setAttribute("manageSearchId", "2");
						%>
							...
							<table class="table table-bordered table-hover table-striped">
								...
								<tr>
									...
									<td>
										<div align="left">
											<a
												href="manageNews?newsId=<%=list.get(i).getId()%>&moduleId=2"
									...
									<td>
										<div align="center">
											<img src="../images/dow.gif" width="16" height="16" /> <a
												href="../manager/downloadSingle?newsId=<%=list.get(i).getId()%>&moduleId=2">下载</a>&nbsp;
											&nbsp; <img src="../images/edt.gif" width="16" height="16" />
											<a
												href="manageNewsModify?newsId=<%=list.get(i).getId()%>&moduleId=2">
												修改</a>&nbsp;&nbsp; <img src="../images/del.gif" width="16"
												height="16" /> <a
												href="DeleteSingle?newsId=<%=list.get(i).getId()%>&moduleId=2"
											...
											<img src="../images/<%=pub%>.gif" height="18" />&nbsp;<a
												href="isVisible?newsId=<%=list.get(i).getId()%>&moduleId=2&visible=<%=list.get(i).getVisible()%>"><%=isPub%></a>
													...
													<table>
														<tr>
															<td id="download" name="download"><input
																...
																onclick="choseFileType(2)"></td>
															<td><input type="submit" name="submit" value="删除"
																onclick="return deleteBatch(2)">
															</td>
															<td><input type="submit" name="submit"
																value=" 导出到  [ 一周热点参考  ] " onclick="return dtrd(2)">
															</td>
								...
								<tr>
									<td colspan="7" style="text-align:center"><jsp:include
											...
											<jsp:param value="getManageData?moduleId=2" name="action" /></jsp:include></td>
								</tr>
							</table>
						</div>
				</div>
