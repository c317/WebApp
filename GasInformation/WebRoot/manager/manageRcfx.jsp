					...
					<ol class="breadcrumb">
						...
						<table class="table table-condensed"
							...
							<form action="updateword" method="post">
								<td><input type="submit" name="btnHotW" id="btnHotW" value="词表更新"/></td>
							</form>
							<form action="manageRcfx1.jsp" target="_blank" method="post" >
								<td align="right"><!-- <select id="moduleMK" name="moduleMK">
									...
									style="width: 80px" />&nbsp; 
								 <input type="submit" name="button" id="button" value="词频分析"
