<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%
			String bagintime=request.getParameter("startTime");
		...
		<div id="content">
			<div class="row">
				<div class="col-md-2 col-xs-2 col-sm-2 col-lg-2">
					<%
						request.setAttribute("manageLeftNav3", "Rcfx");
					%>
				...
				<div class="col-md-10 col-xs-10 col-sm-10 col-lg-10">
					<ol class="breadcrumb">
						<li><a href="#">业务定制</a></li>
						<li><a href="#" class="active">高频词频数分析</a></li>
					</ol>
						...
						<!-- <table class="table table-condensed"
							...
							<form action="jfreechart" method="post">
								<td align="right"><select id="moduleMK" name="moduleMK">
									...
									style="width: 80px" />&nbsp; 
								 <input type="submit" name="button" id="button" value="分析热词"
					 ...
					 <table class="table table-bordered" height="400px"
						...
						<tr>
							<td>
								<img src="jfreechart.action?begintime=<%=bagintime %>&endtime=<%=endtime %>" width="700" height="400" />
							</td>
						</tr>
						<tr>
								<td align="center"><font size="4"><%=bagintime%>至<%=endtime %></font></td>
							</tr>
					</table> 
