		...
		<div id="content">
			<div class="row">
				<div class="col-md-2 col-xs-2 col-sm-2 col-lg-2">
					<%
						request.setAttribute("manageLeftNav", "Tjsj");
					%>
				...
				<div class="col-md-10 col-xs-10 col-sm-10 col-lg-10">
					...
					<form action="#" method="post" id="form1" name="form1">
						<%
							request.setAttribute("manageSearchId", "9");
						%>
							...
							<table class="table table-bordered table-hover table-striped">
								...
								<tr>
									...
									<td>
										<div align="left">
											<a
												href="manageNews?newsId=<%=list.get(i).getId()%>&moduleId=9"
									...
									<td>
										<div align="center">
											<img src="../images/dow.gif" width="16" height="16" /> <a
												href="../manager/downloadSingle?newsId=<%=list.get(i).getId()%>&moduleId=9">下载</a>&nbsp;
											&nbsp; <img src="../images/edt.gif" width="16" height="16" />
											<a
												href="manageNewsModify?newsId=<%=list.get(i).getId()%>&moduleId=9">
												修改</a>&nbsp;&nbsp; <img src="../images/del.gif" width="16"
												height="16" /> <a
												href="DeleteSingle?newsId=<%=list.get(i).getId()%>&moduleId=9"
											...
											<img src="../images/<%=pub%>.gif" height="18" />&nbsp;<a
												href="isVisible?newsId=<%=list.get(i).getId()%>&moduleId=9&visible=<%=list.get(i).getVisible()%>"><%=isPub%></a>
													...
													<table>
														<tr>
															<td id="download" name="download"><input
																...
																onclick="choseFileType(9)">
															</td>
															<td><input type="submit" name="submit" value="删除"
																onclick="return deleteBatch(9)"></td>
															<td><input type="submit" name="submit"
																value=" 导出到  [ 一周热点参考  ] " onclick="return dtrd(9)">
															</td>
								...
								<tr>
									<td colspan="7" style="text-align:center"><jsp:include
											...
											<jsp:param value="getManageData?moduleId=9" name="action" /></jsp:include></td>
								</tr>
							</table>
						</div>
				</div>
