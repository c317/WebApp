	...
	<div id="content">
		<div class="row">
			<div class="col-md-2 col-xs-2 col-sm-2 col-lg-2">
				<%request.setAttribute("manageLeftNav", "Yjxx");%>
			...
			<div class="col-md-10 col-xs-10 col-sm-10 col-lg-10">
				...
				<form action="#" method="post" id="form1" name="form1">	
					<%
							request.setAttribute("manageSearchId", "11");
					%>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-striped">
						<thead  align="center">
							<tr>
								<td>
									<input type="checkbox" name="checkbox" onclick="isAll()"></td>
								<td>序号</td>
								<td>标题</td>
								<td>发布时间</td>
								<td>起始来源</td>
						...
						<tr>
							...
							<td>
								<div align="left">
								<a href="manageNews?newsId=<%=list.get(i).getId()%>&moduleId=11"target="_blank" title="<%=title%>"
							...
							<td>
								<div align="center">
									<img src="../images/dow.gif" width="16" height="16" />
										<a href="../manager/downloadSingle?newsId=<%=list.get(i).getId()%>&moduleId=11"
											>下载</a>&nbsp; &nbsp; 
									<img src="../images/edt.gif" width="16" height="16" />
										<a href="manageNewsModify?newsId=<%=list.get(i).getId()%>&moduleId=11">
											修改</a>&nbsp;&nbsp;
									<img src="../images/del.gif" width="16" height="16" />
										<a href="DeleteSingle?newsId=<%=list.get(i).getId()%>&moduleId=11"
											...
											删除</a>&nbsp;&nbsp;
															...
															<img src="../images/<%=pub%>.gif" height="18" />&nbsp;<a
																href="isVisible?newsId=<%=list.get(i).getId()%>&moduleId=11&visible=<%=list.get(i).getVisible()%>"><%=isPub%></a>
						...
						<tr>
							...
							<tr>
								<td align="left">								
									<table>
										<tr>
											<td><input type="submit" name="submit" value="下载" onclick="return downloadBatch(11)"></td>
											<td><input type="submit" name="submit" value="删除" onclick="return deleteBatch(11)"></td>
											<td><input type="submit" name="submit" value="导出到一周热点" onclick="return dtrd(11)"></td>
											<td><input type="submit" name="submit" value="导出到工作动态与参考" onclick="return dtck(11)"></td>
										</tr>
									</table>
								</td>
								<td align="right"><jsp:include page="manageSearchByTitle.jsp"></jsp:include></td>				
							</tr>
							</table>
							</td>
						</tr>
						...
						<tr>
							...
							<jsp:param value="getManageData?moduleId=11" name="action" /></jsp:include></td>
						</tr>
					</table>
				</div>
			</div>
