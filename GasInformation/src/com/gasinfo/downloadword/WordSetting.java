...
public class WordSetting {
	private static final WordSetting wordSetting = new WordSetting();
	 ...
	 * 设置首行缩进2个字符
	 */
	public void setParagraphIndInfo(XWPFParagraph p) {  
        CTPPr pPPr = getParagraphCTPPr(p); //段落样式控制器
        CTInd pInd = pPPr.getInd() != null ? pPPr.getInd() : pPPr.addNewInd(); //缩进控制器
        pInd.setFirstLine(new BigInteger("440"));   
        pInd.setFirstLineChars(new BigInteger("200"));  
    }
