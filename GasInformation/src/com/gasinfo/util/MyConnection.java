...
public class MyConnection implements Connection{
	...
	private MyDataSource dataSourse;
	private int maxUseCount =10;
	private int currentUserCount =0;
	MyConnection(Connection connection,MyDataSource dataSourse){
	...
	public void close() throws SQLException {
		...
		if(this.currentUserCount<this.maxUseCount)
			 this.dataSourse.connectionsTool.addLast(this);
		else{
			this.realConnection.close();
			this.dataSourse.currentCount--;
		}
